...
function cadastrarHotel() {
     ...
     id = parseInt(prompt("Insria o ID do hotel:"))
     nome = prompt("Insira o nome do hotel:")
     categoria = prompt("Insira a categoria do hotel:")
     endereco = prompt("INsira o endereço do hotel:")
     telefone = prompt("Insira o telefone do hotel:")
